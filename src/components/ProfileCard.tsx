  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      if (typeof anyMotion.requestPermission === 'function') {
        anyMotion.requestPermission().then(s => {
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="rounded-full overflow-hidden border border-white/10 flex-shrink-0 w-10 h-10">
                      <img
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="text-[12px] font-medium text-white/90 leading-none">@{handle}</div>
                      <div className="text-[11px] text-white/60 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/10 rounded-lg px-3 py-2 text-[11px] font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 hover:border-white/40 hover:-translate-y-px"
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '2.5em' }}>
                <h3
                  ...
                  style={{
                    fontSize: 'clamp(1.2rem, 4svh, 2rem)',
